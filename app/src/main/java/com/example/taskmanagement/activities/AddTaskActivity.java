...
//                    ((TextView) adapterView.getChildAt(0)).setTextColor(Color.blue());
    ...
    private void doneWork(String cName,String tName )
    {
        ...
        binding.done.setOnClickListener(view -> {
            ...
            {
                sendData(title,description,fromDate,toDate,t_pos,finalCName,finalTName,designation,status);
//
            }
    ...
    private void sendData(String title, String description, String fromDate, String toDate, String t_pos,String cName,String tName,String des,String sts) {
        obj.getFirebaseDatabase().getReference().child(COMPANIES).child(cName).child(TEAMS).child(tName).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                AddTaskModel model=new AddTaskModel(title,description,fromDate,toDate,t_pos,des,sts);
